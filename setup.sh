...
wget -q raw.githubusercontent.com/kjsstore/kjs-new/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
...
wget https://raw.githubusercontent.com/kjsstore/kjs-new/main/Cfg/m-noobz 
